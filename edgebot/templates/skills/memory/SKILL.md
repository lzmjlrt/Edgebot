...
- `MEMORY.md` - bounded index of long-term topic files. Managed by Dream.
- `memory/topics/*.md` - durable topic details with structured metadata. Managed by Dream.
...
- When the user explicitly asks to save durable information, call `remember`; it queues an audited request for Dream. Never use workspace filesystem tools to edit runtime memory files.
